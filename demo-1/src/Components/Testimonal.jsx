            ...
            <div>
                ...
                >
                    <div
                        ...
                        data-aos-once="true"
                    >
                        <h2 class="title sec-title pt-5 mt-5" style={{ color: "#fd562a" }}>
                            TESTIMONAL
                        </h2>
                        <span
                            class="subtitle sub-title text-light"
                                                ...
                                                <div class="card-description ">
                                                    <div class="title-area">
                                                        <div class="title-info">
                                                            <h3 class="title heading6">Alfred James</h3>
                                                    ...
                                                    <p class="description heading3">Highly recommended. Respectful, polite, great communication,
                                        ...
                                        <div className="col-md-8">
                                            <div className="user">
                                                <div class="card-description ">
                                                    <div class="title-area">
                                                        <div class="title-info">
                                                            <h3 class="title heading6">Adam Jones</h3>
                                                            <span class="date"> </span>
                                                        </div>
                                                    ...
                                                    <div className="my-3 border"></div>
                                                    <div class="seperator"></div>
                                                    <p class="description heading3">Kalyan’s understanding and execution are outstanding. He delivered 
                                        ...
                                        <div className="col-md-8">
                                            <div className="user">
                                                <div class="card-description ">
                                                    <div class="title-area">
                                                        <div class="title-info">
                                                            <h3 class="title heading6">Megan</h3>
                                                            <span class="date"> </span>
                                                        </div>
                                                    ...
                                                    <div className="my-3 border"></div>
                                                    <div class="seperator"></div>
                                                    <p  class="description heading3">Kalyan is exceptional! His attention to detail, problem-solving 
